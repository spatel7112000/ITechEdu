                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="input__label">EmailID</label>
                            <input type="text" class="form-control login_text_field_bg input-style"
                                id="exampleInputEmail1" name="EmailID" aria-describedby="emailHelp" placeholder="" required=""
                                autofocus>
                        ...
                        <div class="form-check check-remember check-me-out">
                            ...
                            <label class="form-check-label checkmark" for="exampleCheck1" required>Remember
                                me</label>
                        </div>
