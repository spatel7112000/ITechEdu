          ...
          <div class="col-lg-12">
            <div class="bootstrap-data-table-panel">
                                          ...
                                          <thead>
                                              <tr>
                                                  ...
                                                  <th>Action</th>
                                                                       ...
                                                                       <?php
             $selectquery = "select * from tblcourse";
             ...
             while ($res = mysqli_fetch_array($query)){
              ...
              <tr>
                  <td>#ID-<?php echo $res['No']; ?></td>
                  <td><?php echo $res['Course']; ?></td>
                  <td><?php echo $res['Topic']; ?></td>
                  <td><?php echo $res['Lesson']; ?></td>
                  <td><?php echo $res['Date']; ?></td>
                  <td><span class="badge badge-primary">
                  <a href="updatecourse.php?No=<?php echo $res['No']; ?>" style="color: white;">Update</a></span>&nbsp;<span class="badge badge-danger">
                      <a href="delete/deletecourse.php?No=<?php echo $res['No']; ?>">Remove</a></span>
              </td>
              </tr>
