            ...
            <div class="bootstrap-data-table-panel">
                                          ...
                                          <thead>
                                              <tr>
                                                  ...
                                                  <th>Action</th>
                                                                       ...
                                                                       <?php
             $selectquery = "select * from tblblog";
             ...
             while ($res = mysqli_fetch_array($query)){
              ...
              <tr>
                  ...
                  <a href="updateblog.php?No=<?php echo $res['No']; ?>" style="color: white;">Update</a></span>&nbsp;<span class="badge badge-danger">
                      <a href="delete/deleteblog.php?No=<?php echo $res['No']; ?>">Remove</a></span>
              </td>
              </tr>
