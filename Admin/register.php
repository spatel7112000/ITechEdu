...
<body class="sidebar-menu-collapsed">
    ...
    if(isset($_POST['create'])) {
        ...
        move_uploaded_file($_FILES["Admin"]["tmp_name"], "Images/Admin_img/". $_FILES["Admin"]["name"]);

        $pass = password_hash($Password, PASSWORD_BCRYPT);
        $insertquery = "insert into tbladmin(AdminID,EmailID,Password,Admin) values('$AdminID','$EmailID','$pass','$Admin')";
            ...
            <div class="card card_border p-md-4">
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="exampleThumbnail" class="input__label">Admin</label><br>
                        
                      <div class="custom-file">
                            <input type="file" class="custom-file-input" name="Admin" id="validatedCustomFile" required>
