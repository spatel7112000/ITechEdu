  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        <li><a href="index.php"><i class="fa fa-tachometer"></i><span> Dashboard</span></a>
        </li>
        <li class="menu-list">
        ...
        <li class="active"><a href="pricing.php"><i class="fa fa-table"></i> <span>Pricing tables</span></a></li>
            ...
            <ul>
              <li class="dropdown profile_details_drop">
                ...
                <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                  ...
                  <li class="logout"> <a href="#sign-up.php"><i class="fa fa-power-off"></i> Logout</a> </li>
                </ul>
              </li>
            </ul>
          </div>
              ...
              <div class="col-md-4 px-2">
                <div class="mb-4 price-card price-card1 p-lg-4 p-md-3 p-4">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="mt-4">
                      <a href="signup.php" class="btn btn-lg btn-outline-primary btn-style border-btn">Sign up for
                        free</a>
                    </div>
                  </div>
                </div>
