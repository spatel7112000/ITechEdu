  ...
  <section class="template-cards">
    <div class="card">
      <div class="cards__heading">
        ...
        <?php
             $selectquery = "select * from tbladmin";
             ...
             while ($res = mysqli_fetch_array($query)){
              ...
              <tr>
                  ...
                  <a href="updateAdmin.php?ID=<?php echo $res['ID']; ?>" style="color: white;">Update</a></span>&nbsp;<span class="badge badge-danger">
                      <a href="delete/DeleteAdmin.php?ID=<?php echo $res['ID']; ?>">Remove</a></span>
              </td>
              </tr>
