...
if(isset($_POST['Launch'])) {
        ...
        $insertquery = "insert into tblcourse(Topic,Course,Lesson,Thumb,DLink) values('$Topic','$Course','$Lesson','$Thumb','$DLink')";
         ...
         <!-- forms -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Add <span>Course</span></h3>
                </div>
                <div class="card-body">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleInputCourse" class="input__label">Course</label>
                            <input type="text" class="form-control input-style" placeholder="Course" name="Course" required>
                        </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputTopic" class="input__label">Topic</label>
                            <input type="text" class="form-control input-style" placeholder="Topic" name="Topic" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputLesson" class="input__label">Lesson</label>
                            <input type="text" class="form-control input-style" placeholder="Lesson" name="Lesson" required>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="custom-file">
                            <input type="file" class="custom-file-input" name="DLink" id="validatedCustomFile" required>
                            <label class="custom-file-label" for="validatedCustomFile">Choose file...</label>
                        </div>
                      </div>
