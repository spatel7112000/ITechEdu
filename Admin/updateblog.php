<?php include('includes/config.php');
    ...
    if(isset($_POST['Post'])) {
        ...
        $updatequery = "UPDATE tblblog SET No='$No',BName='$BName',AName='$AName',Author='$Author',Thumb='$Thumb',content='$content' WHERE No='$No' ";       
         ...
         <!-- forms -->
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Update <span>Blog</span></h3>
                </div>
                <div class="card-body">
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleInputCourse" class="input__label">BName</label>
                            <input type="text" class="form-control input-style" value="<?php echo $arrdata['BName']; ?>" name="BName" required>
                        </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputTopic" class="input__label">AName</label>
                            <input type="text" class="form-control input-style" value="<?php echo $arrdata['AName']; ?>" name="AName" required>
                        </div>                       
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                            <label for="exampleThumbnail" class="input__label">Author</label><br>
                      ...
                      <div class="form-group">
                            ...
                            <textarea type="text" name="content" class="form-control input-style" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $arrdata['Content']; ?>"></textarea>
                           
                        </div>
                        <button type="submit" class="btn btn-primary btn-style mt-4" name="Post">Launch</button>
                    </form>
                    <script>
